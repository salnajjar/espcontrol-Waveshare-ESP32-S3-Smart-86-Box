...
const screenProducts: Record<string, Record<string, string>> = {
  ...
  'screens/s3-smart-86-box.md': {
    name: 'Waveshare ESP32-S3 Smart 86 Box',
    brand: 'Waveshare',
    model: 'ESP32-S3 Smart 86 Box',
    size: '4 inches',
    resolution: '480 x 480',
    processor: 'ESP32-S3',
  },
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'The home screen supports 20 cards on JC8012P4A1, 15 on JC1060P470, 6 on JC4880P443, and 9 on 4848S040, ESP32-P4 86 Panel, or ESP32-S3 Smart 86 Box, with more available through subpages.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'EspControl supports the Guition JC8012P4A1, JC1060P470, JC4880P443, 4848S040, ESP32-P4 86 Panel, and Waveshare ESP32-S3 Smart 86 Box touchscreens.',
  },
  {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '4-inch ESP32-S3 Smart 86 Box', link: '/screens/s3-smart-86-box' },
        ],
      },
      {
        text: 'Configuring',
